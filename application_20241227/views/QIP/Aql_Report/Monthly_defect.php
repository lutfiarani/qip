               ...
               <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group date">
                        ...
                        <input placeholder="date from yyyy-mm-dd" type="text" class="form-control datepicker" name="START_DATE" autocomplete="off">
                        <input placeholder="date to yyyy-mm-dd" type="text" class="form-control datepicker" name="END_DATE" autocomplete="off">
                    </div>
