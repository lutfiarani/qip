                ...
                {   
                    ...
                    html +='<div class="card-header">'+
                          ...
                          if(bonding.RESULT=='Released'){
                              html +="<td bgcolor='green' class='text-white' style='width: 200px'>PASS</td>";
                          }else{
                              html +="<td bgcolor='red' class='text-white' style='width: 200px'>FAILED</td>";
                          }
                        html +="</tr></tbody></table></div>";
                ...
                {   
                    ...
                    html+=  '<div class="card-header">'+
                            ...
                            '<div class="card-body">'+
                                ...
                                '<tbody>';
                                for (i=0; i<data.length; i++){
                                    if((data[i].report_type.name == 'FTW - AQL Outbound')){
                                        html += '<tr>'+
                                                    '<td><center>'+data[i].assignments_items[0].inspection_completed_date+'</center></td>'+
                                                    '<td><center>'+data[i].inspector.name+'</center></td>';
                                            if(data[i].assignments_items[0].inspection_result_text ==='Pass'){ //ada
                                                html += '<td bgcolor="green" class="text-white"><center>'+ data[i].assignments_items[0].inspection_result_text+'</center></td>'
                                            }else if(data[i].assignments_items[0].inspection_result_text ==='Fail'){
                                                html += '<td bgcolor="red" class="text-white"><center>'+ data[i].assignments_items[0].inspection_result_text+'</center></td>'
                                            }else{
                                                html += '<td bgcolor="#FFFFFF" class="text-white"><center>'+ data[i].assignments_items[0].inspection_result_text+'</center></td>'
                                            }
                                        if (data[i].assignments_items[0].booking_msg == null){
                                            html += '<td></td>'
                                        }else{
                                            html += '<td><center>'+ data[i].assignments_items[0].booking_msg+'</center></td>'
                                        }
