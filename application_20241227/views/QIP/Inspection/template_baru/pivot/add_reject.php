              ...
              <form method="POST" id="form_pivot" name="form_pivot" enctype="multipart/form-data" hidden>
                  ...
                  <?php
                      foreach($decoded_data['po_line'] as $line){
                        echo '<br><input type="text" id="PO[]" name="PO[]" value="'.$po.'">';
                        echo '<br><input type="text" id="SKU[]" name="SKU[]" value="'.$line['sku']['sku_number'].'">';
                        echo '<br><input type="text" id="SIZE[]" name="SIZE[]" value="'.$line['size'].'">';
                        echo '<br><input type="text" id="PROJECT_CODE[]" name="PROJECT_CODE[]" value="'.$line['sku']['project']['project_code'].'">';
                      }
                  ?>
              </form>
