...
<!-- <input id="po" class="form-control" name="text" type="text" value='*AQL Inspection ( <?php echo count($data)?> PO Belum Inspect) *
            <?php echo "\n\n\n";?>
            ...
            <?php echo "\n\n\n";?>
                ...
                * <?php echo $row->PO_NO; ?>*  - Gedung *<?php echo $row->FACTORY; ?>*
                <?php echo "\n";}?>
