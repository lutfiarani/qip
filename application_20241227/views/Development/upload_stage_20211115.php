...
<section class="content">
      <div class="row">
        ...
        <div class="card">
            ...
            <form method="post" id="import_file" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-sm-4">
                      ...
                      <div class="form-group">
                        ...
                        <!-- <input type="text" class="form-control" placeholder="Enter ..."> -->
                            <select class="form-control select2"  data-show-subtext="true" data-live-search="true" id="model" name="model">
                            <!-- <input type="text" placeholder="Search.." id="myInput" onkeyup="filterFunction()"> -->
                                <option data-tokens="">kosong</option>
                                <?php
                                    $no = 1;
                    ...
                    <div class="col-sm-4">
                      <div class="form-group">
                        <label>Stage</label>
                        <select class="form-control select2"  data-show-subtext="true" data-live-search="true" id="stage" name="stage">
                              <option value=""></option>
                              <?php
                                    $no = 1;
                                    for($i = 0; $i < count($stage); $i++){
                                        // if($model[$i]['MODEL']== $row['MODEL']){
                                            ...
                                            echo "<option data-tokens='".$stage[$i]['STAGE_ID']."' value='".$stage[$i]['STAGE_ID']."' selected>".$stage[$i]['STAGE_NAME']."</option>";
                                        }else{
                    ...
                    <div class="col-sm-4 date" >
                      <div class="form-group">
                        <label>Date</label>
                        <input type="text" id="tanggal" name="tanggal" data-provide="datepicker"  class="form-control" placeholder="Enter ..." autocomplete="off">
                      </div>
                    </div>
                 </div>
                 <div class="row">
                    ...
                    <div class="col-sm-8">
                      <div class="form-group">
                        <label>Remark</label>
                        <textarea rows="3" class="form-control" placeholder="Enter ..." id="remark"></textarea>
                      </div>
                    </div>
            ...
            <canvas border ='1' id="pdfViewer"  name="pdfViewer"></canvas>
  ...
  <!--MODAL DELETE------------>
    ...
    $(document).ready(function(){
        ...
        $(document).on('click','.edit',function(){
            ...
            $.ajax({
              type : "POST",
              url  : "<?php echo site_url('C_dev_stage/send_email')?>",
              dataType : "JSON",
