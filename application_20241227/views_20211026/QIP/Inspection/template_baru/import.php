            ...
            <form method="post" id="import_form" enctype="multipart/form-data">
                <div class="form-group">
                  ...
                  <div class="card-footer">
                    <a href="<?= base_url('upload/format/inspection_result.xlsx') ?>" class="btn btn-success btn-sm">Download Format Import Data</a>
    ...
    <script>
        ...
        $(document).ready(function(){
          tableListExport = $('#listExport').DataTable({
            "sScrollX": "100%",
              "ajax"  :{
                url   : "<?php echo site_url('C_Inspection/list_mes_inspect');?>",
                datatype  : 'json',
                responsive: true
              },
          });
          ...
          $('#import_form').on('submit', function(event){
                ...
                $.ajax({
                    url: "<?php echo site_url('C_Inspection/import_mes')?>",
                    method:"POST",
