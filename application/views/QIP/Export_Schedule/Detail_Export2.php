                  ...
                  <tbody>
                    <?php
                        ...
                        for ($i=0; $i<$jumlah; $i++){
                                ...
                                echo "<tr>
                                    <td><center>$data[INSPECT_DATE]</center></td>
                                    <td><center>$data[INSPECTOR]</center></td>
                                    <td><center>$data[RESULT]</center></td>
                                    <td><center>$data[REMARK]</center></td>
                    ...
                    <tr>
                      ...
                      <?php 
                          if($bonding->RESULT=='Released'){
                              echo "<td bgcolor='green' style='width: 200px'>PASS</td>";
                          }else{
                              echo "<td bgcolor='red' style='width: 200px'>FAILED</td>";
                          }
                        ?>
