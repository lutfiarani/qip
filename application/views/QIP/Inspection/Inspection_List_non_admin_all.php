           ...
           success   : function(data)
            {
              ...
              var html2 ='';
                ...
                for(i=0; i<data.view_all.length; i++){
                  if((data.view_all[i].STATUS_PO_AQL == 'RELEASE')||(data.view_all[i].STATUS_PO_AQL == 'PASS')){
                      html += '<tr style="background-color:#00cc00">';
                    }else if(data.view_all[i].STATUS_PO_AQL == 'REJECT')
                    {
                      html += '<tr style="background-color:#FF0000">';
                    }else if(data.view_all[i].STATUS_PO_AQL == 'REPACKING'){
                      html += '<tr style="background-color:#A0A0A0">';
                    }else if(data.view_all[i].STATUS_PO_AQL == 'WAITING'){
                      html += '<tr style="background-color:#3399FF">';
                    }else if(data.view_all[i].STATUS_PO_AQL == 'PRODUCTION'){
                      html += '<tr style="background-color:#FFFF99">';
                    }else if(data.view_all[i].STATUS_PO_AQL == 'CANCEL'){
                    ...
                    html += 
                                ...
                                html +='<td>'+data.view_all[i].STATUS_PO_AQL+'</td>'+
                             '</tr>';
