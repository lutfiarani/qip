        ...
        foreach ($query as $haha) {
            ...
            if($a != $haha['CONTAINER']){
                ...
                if ($haha['STATUS_PO2']=='RELEASE')
                    ...
                    } else if ($haha['STATUS_PO2']=='PRODUCT')
                    {
                ...
                <td style ='word-break:break-word; font-size: 90%;'>$haha[FACTORY]</td>
                <td style ='word-break:break-word; font-size: 90%;'>$haha[CELL]</td>
                <td style ='font-size: 90%;'> <a href='".site_url('C_Export/detail_export/'.$haha['PO_NO'])."'>$haha[PO_NO]</a> </td>
                <td style ='word-break:break-word; font-size: 90%;'>$haha[MODEL_NAME]</td>
                <td style ='word-break:break-word; font-size: 90%;'>$haha[COUNTRY]</td>
                <td style ='word-break:break-word; font-size: 90%;'>$haha[ART_NO]</td>
                <td style ='word-break:break-word; font-size: 90%;'>$haha[TOTAL_QTY]</td>
                <td style ='word-break:break-word; font-size: 90%;'>$haha[SDD]</td>
                <td style ='word-break:break-word; font-size: 90%;'>$haha[TYPE]</td>
                <td style ='word-break:break-word; font-size: 90%;'>$haha[REMARK]</td>
